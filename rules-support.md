![A-Play Support](https://i.imgur.com/bxbp3kO.jpg)

# NỘI QUY NHÓM A-PLAY SUPPORT
...
- Vừa tham gia Facebook chưa được 3 tháng khi xin vào nhóm.
...
- Tài khoản không có tên hiển thị (Facebook ma), tên sử dụng ký tự đặc biệt, không có tên họ rõ ràng ( Chỉ chấp nhận tên có kèm biệt danh có tên họ rõ ràng, ví dụ: **Lang Thang (Văn Tuấn)** )
...
Nhóm được quản lý bởi [A-Play Support](https://facebook.com/groups/aplay.support) nên tất cả các bài viết **bắt buộc** chỉ được liên quan đến ứng dụng **A-Play**.
